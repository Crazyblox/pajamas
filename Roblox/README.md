...
This is the directory for the Roblox runtime version of pajamas.

This directory is compatible with importing directly into Roblox Studio.

In order to use pajamas in Roblox Studio, create a Folder in your experience with the same name as your download of this directory; then use file-sync to import the files into Roblox Studio.
